    ...
    <Modal :show="show" :max-width="maxWidth" :closeable="closeable" @close="close">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-slate-900 mx-4">
            <div>
                ...
                <input type="text" v-model="formCliente.cargo" :placeholder="formCliente.cargo" class="custom-input" /> 
            </div>
            <div>
                <label for="name">Nombre:</label>
                <input type="text" v-model="formCliente.name" :placeholder="formCliente.name" class="custom-input" />
            </div>
            <div>
                <label for="last_name">Apellido:</label>
                <input type="text" v-model="formCliente.last_name" :placeholder="formCliente.last_name" class="custom-input" />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="date" v-model="formCliente.fecha_nacimiento" :placeholder="formCliente.fecha_nacimiento" class="custom-input" />
            </div>
            <div>
                <label for="telefono">Teléfono:</label>
                <input type="text" v-model="formCliente.telefono" :placeholder="formCliente.telefono" class="custom-input" />
            </div>
            <div>
                <label for="email">Correo Electrónico:</label>
                <input type="email" v-model="formCliente.email" :placeholder="formCliente.email" class="custom-input" />
            </div>
            <div>
                <label for="address">Dirección:</label>
                <input type="text" v-model="formCliente.address" :placeholder="formCliente.address" class="custom-input" />
            </div>
            <div>
                <label for="ciudad">Ciudad:</label>
                <input type="text" v-model="formCliente.ciudad" :placeholder="formCliente.ciudad" class="custom-input" />
            </div>
            <div>
                <label for="region">Región:</label>
                <input type="text" v-model="formCliente.region" :placeholder="formCliente.region" class="custom-input" />
            </div>
            <div>
                <label for="isapre">Isapre:</label>
                <input type="text" v-model="formCliente.isapre" :placeholder="formCliente.isapre" class="custom-input" />
            </div>
            <div>
        ...
        <button type="button"  @keydown.enter="editUser()" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
            <input type="submit" value="Guardar" title="Guardar" @click="editUser()" @keydown.enter="editUser()" />
        </button>
        </form>
...
.custom-input {
  ...
  padding: 0.5rem; /* Añadir un padding para mejor apariencia */
