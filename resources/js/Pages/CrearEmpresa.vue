    ...
    <AppLayout title="Crear Empresa Nueva">
      ...
      <form @submit.prevent="submit">
        <div class="p-4 text-gray-900 w-3/4 justify-center">
          ...
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Nombres Persona Natural:</label>
            <input type="text" v-model="form.nombresPersonaNatural" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Apellido Paterno Persona Natural:</label>
            <input type="text" v-model="form.apellidoPaternoPersonaNatural" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Apellido Materno Persona Natural:</label>
            <input type="text" v-model="form.apellidoMaternoPersonaNatural" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">RUT Empresa Persona:</label>
          ...
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Comuna:</label>
          ...
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Fono:</label>
            <input type="text" v-model="form.fono" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Mail:</label>
            <input type="email" v-model="form.mail" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Nombre Banco:</label>
            <input type="text" v-model="form.nombreBanco" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Número Cuenta:</label>
            <input type="text" v-model="form.numeroCuenta" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Representante Legal:</label>
            <input type="text" v-model="form.representanteLegal" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">RUT Representante Legal:</label>
            <input type="text" v-model="form.rutRepresentanteLegal" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Mail Representante Legal:</label>
            <input type="email" v-model="form.mailRepresentanteLegal" 
                   class="mt-1 block border-gray-300 w-3/4 rounded-md shadow-sm focus:border-orange-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
          </div>
  
          <div class="flex">
            <label class="block text-sm w-1/4 font-medium text-white mt-4">Fono Representante Legal:</label>
